...
int main(int argc, char **argv) {
  ...
  run_test(test_todos_los_leds_inician_apagados,
           "test_todos_los_leds_inician_apagados", 77);
  ...
  run_test(test_prender_y_apagar_algunos_leds,
           "test_prender_y_apagar_algunos_leds", 98);
  ...
  run_test(test_consultar_estado_led_encendido,
           "test_consultar_estado_led_encendido", 120);
  run_test(test_consultar_estado_led_apagado,
           "test_consultar_estado_led_apagado", 126);
  ...
  run_test(test_revisar_parametros_fuera_de_limites,
           "test_revisar_parametros_fuera_de_limites", 143);
